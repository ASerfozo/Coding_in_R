...
```{r message=FALSE, warning=FALSE, echo=FALSE, out.width = '50%', fig.height=3.8}
...
```{r message=FALSE, warning=FALSE, echo=FALSE, out.width = '50%', fig.height=3.8, fig.align='center'}
...
# library(jtools)
# 
# mss <- export_summs(reg1,reg2,reg3,
#                     model.names = c("simple linear","PLS","PLS extended"))
# rs <- as_hux(mss)
# rs
