...
#write csv
write.csv(df,file=paste0(data_out,"airbnb_rome_workfile_v1.csv"))

rm(backup, less_than_3, more_than_3, tdf, binary, drops, levs, perc, pricevars, df)

# Prepare Data ------------------------------------------------------------
data <- read_csv(paste(data_out,"airbnb_rome_workfile_v1.csv", sep = ""))
...
write_csv(data, paste0(data_out, "airbnb_rome_workfile_v2.csv"))
...
write_csv(data, paste0(data_out, "airbnb_rome_workfile_v3.csv"))
