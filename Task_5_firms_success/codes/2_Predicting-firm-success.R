...
path <- "D:/Egyetem/CEU/Winter_Term/Data_Analysis_3/Assignments/Assignment_2/"


# set data dir, data used
source(paste0(path, "codes/theme_bg.R"))             
source(paste0(path, "codes/da_helper_functions.R"))


data_in <- paste0(path,"data/clean/")
data_out <- data_in
output <- paste0(path,"out/")
create_output_if_doesnt_exist(paste0(path,"out"))
